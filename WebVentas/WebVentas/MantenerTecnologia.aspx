<%@ Page Title="" Language="C#" MasterPageFile="~/PrincipalAdministrador.Master" AutoEventWireup="true" CodeBehind="MantenerTecnologia.aspx.cs" Inherits="WebVentas.MantenerTecnologia" %>
     ...
     <table class="style1">
        ...
        <tr>
            ...
            <td class="auto-style1">
                Tecnologia:</td>
            <td width="20%">
                <asp:TextBox ID="txtcodtip" runat="server" 
                    onkeypress="javascript:return sololetras(event)" TabIndex="1"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                    ControlToValidate="txtcodtip" Display="Dynamic" ErrorMessage="*" 
        ...
        <tr>
            ...
            <td class="auto-style1">
                Descripcion:</td>
            <td>
                <asp:TextBox ID="txtdestip" runat="server" 
                    onkeypress="javascript:return sololetras(event)" TabIndex="2"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                    ControlToValidate="txtdestip" Display="Dynamic" ErrorMessage="*" Font-Bold="True" 
          ...
          <tr>
            ...
            <td class="auto-style1">
                Durabilidad:</td>
            <td>
                <asp:TextBox ID="txtdurabilidad" runat="server" TabIndex="4"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" 
                    ControlToValidate="txtdurabilidad" Display="Dynamic" ErrorMessage="*" Font-Bold="True" 
                    ForeColor="Red"></asp:RequiredFieldValidator>
            </td>
            <td>
                &nbsp;</td>
        ...
        <tr>
            <td colspan="10">
                <asp:GridView ID="gvTecnologia" runat="server" Width="1005px" 
                    ...
                    <Columns>
                        <asp:BoundField DataField="codtip" HeaderText="Tecnologia" />
                        <asp:BoundField DataField="destip" HeaderText="Descripcion" />
                        <asp:BoundField DataField="durabilidad" HeaderText="Durabilidad" />
